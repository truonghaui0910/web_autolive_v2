import { RevealGroup, RevealItem } from '@/Components/Landing/motion/Reveal';
...
export default function StatsBanner() {
    return (
        <section className="border-y border-white/10">
            <RevealGroup as="div" className="container-lg grid grid-cols-2 gap-8 py-14 lg:grid-cols-4">
                {stats.map((stat) => (
                    <RevealItem as="div" key={stat.label} className="text-center">
